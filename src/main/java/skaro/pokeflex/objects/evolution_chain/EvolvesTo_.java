...
public class EvolvesTo_ {
    ...
    private List<EvolutionDetail_> evolutionDetails = null;
    ...
    @JsonProperty("evolution_details")
    public List<EvolutionDetail_> getEvolutionDetails() {
        return evolutionDetails;
    }

    @JsonProperty("evolution_details")
    public void setEvolutionDetails(List<EvolutionDetail_> evolutionDetails) {
